...
class CoreImageInfoStub: CoreImageInfoProtocol {
    ...
    static let sample2 = CoreImageInfoStub(url: "https://mapbox.com/assets/medium_fake_image.png", width: 100, height: 200)
    static let sample3 = CoreImageInfoStub(url: "https://mapbox.com/assets/big_fake_image.png", width: 200, height: 400)
    
    static let sample4 = CoreImageInfoStub(url: "https://www.google.by/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png", width: 272, height: 92)
