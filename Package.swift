...
let (coreSearchVersion, coreSearchVersionHash) = ("2.17.0-rc.1", "4b8e96500ed6d42226cd85250682ba4f9597513a8f96e27482f8dd56a57599da")

let mapboxCommonSDKVersion = Version("24.17.0-rc.1")
