...
let (coreSearchVersion, coreSearchVersionHash) = ("2.15.0-rc.1", "936652e8aeddab329f526cf686a4e6f6e7d6688e32caaaf35a07c3e2e4e386fc")

let mapboxCommonSDKVersion = Version("24.15.0-rc.1")
