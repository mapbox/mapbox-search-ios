...
let (coreSearchVersion, coreSearchVersionHash) = ("2.13.0-rc.1", "c96741a9dd322c585660ee8d1d172b0a605a9ecb2264d78623be55acadc1871f")

let mapboxCommonSDKVersion = Version("24.13.0-rc.1")
