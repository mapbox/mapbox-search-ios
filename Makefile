...
ci-dev-test: dependencies
	bundle exec fastlane scan --scheme "Demo" --device "iPhone 15 OS=17.5" --result_bundle "true" --testplan "CI-dev" --output_directory "output"

ci-full-test: dependencies
	bundle exec fastlane scan --scheme "Demo" --device "iPhone 15 OS=17.5" --result_bundle "true" --testplan "Demo" --output_directory "output"
