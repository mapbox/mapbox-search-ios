...
extension SearchError: CustomNSError {
    ...
    public var errorUserInfo: [String: Any] {
        ...
        case .failedToRegisterDataProvider(let error as NSError, let dataProvider):
            ...
            return [NSLocalizedDescriptionKey: description, NSLocalizedFailureReasonErrorKey: "Error:[\(error.description)]"]
            
        case .responseProcessingFailed:
            return [NSLocalizedDescriptionKey: "Search Response Processing Failed,", NSLocalizedFailureReasonErrorKey: "Probably got Nil CoreResponse"]
