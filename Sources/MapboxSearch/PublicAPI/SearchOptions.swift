...
public struct SearchOptions {
    ...
    */
    ...
    /// - Parameter origin: Search origin point. This point is used for calculation of SearchResult ETA and distance fields
    ...
    ///   - origin: Search origin point. This point is used for calculation of SearchResult ETA and distance fields. If no origin location specified, distance will be calculated based on proximity point.
    ...
    public init(routeOptions: RouteOptions) {
        self.init(routeOptions: routeOptions,
                  unsafeParameters: nil)
    }
    ...
    mutating func forceNilArg<T>(_ arg: WritableKeyPath<Self, T?>, message: String) {
    ...
    func merged(_ with: SearchOptions) -> SearchOptions {
        return SearchOptions(countries: countries ?? with.countries,
                             languages: languages,
