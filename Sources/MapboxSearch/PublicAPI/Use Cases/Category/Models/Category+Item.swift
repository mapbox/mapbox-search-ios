...
extension Category.Item {
    ...
    Category.Item(canonicalId: "hotel", name: "hotel", legacyName: "hotel", icon: Maki.hotel)
    ...
    Category.Item(canonicalId: "ev_charging_station", name: "chargingStation", legacyName: "charging station", icon: Maki.chargingStation)
    ...
    Category.Item(canonicalId: "railway_station", name: "railwayStation", legacyName: "train station", icon: Maki.rail)
    ...
    Category.Item(canonicalId: "clothing_store", name: "clothingStore", legacyName: "clothes", icon: Maki.clothingStore)
    ...
    Category.Item(canonicalId: "fitness_center", name: "fitnessCentre", legacyName: "fitness center", icon: Maki.fitnessCentre)
    ...
    Category.Item(canonicalId: "auto_repair", name: "autoRepair", legacyName: "auto repair", icon: Maki.autoRepair)
    ...
    Category.Item(canonicalId: "emergency_room", name: "emergencyRoom", legacyName: "emergency room", icon: Maki.emergencyPhone)
}
