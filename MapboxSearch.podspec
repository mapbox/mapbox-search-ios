Pod::Spec.new do |m|
  m.name = 'MapboxSearch'
  m.version = '2.30.0-SNAPSHOT-08-19--08-52.git-3c0233b'
...
Some iOS platform specifics applies.
  ...
  m.dependency 'MapboxCoreSearch', '2.30.0-SNAPSHOT-08-19--08-52.git-3c0233b'
  m.dependency 'MapboxCommon', '24.30.0-SNAPSHOT-08-19--08-52.git-3c0233b'
end
