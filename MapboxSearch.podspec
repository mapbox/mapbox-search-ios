Pod::Spec.new do |m|
  m.name = 'MapboxSearch'
  m.version = '2.30.0-SNAPSHOT-08-14--15-01.git-222a96b'
...
Some iOS platform specifics applies.
  ...
  m.dependency 'MapboxCoreSearch', '2.30.0-SNAPSHOT-08-14--15-01.git-222a96b'
  m.dependency 'MapboxCommon', '24.30.0-SNAPSHOT-08-14--15-01.git-222a96b'
end
