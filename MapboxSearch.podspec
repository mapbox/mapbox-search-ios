Pod::Spec.new do |m|
  m.name = 'MapboxSearch'
  m.version = '2.33.0-SNAPSHOT-09-26--01-36.git-bac38d6'
...
Some iOS platform specifics applies.
  ...
  m.dependency 'MapboxCoreSearch', '2.33.0-SNAPSHOT-09-26--01-36.git-bac38d6'
  m.dependency 'MapboxCommon', '24.33.0-SNAPSHOT-09-26--01-36.git-bac38d6'
end
